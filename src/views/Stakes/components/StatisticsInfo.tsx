...
const StatisticsInfo = ({index}) => {
  ...
  const fetchInfo = useCallback(async ()=>{
    ...
    const pendingFalopa = await stakingContract.methods.getpendingFalopa(index, account).call();
    ...
    setPoolInfo({rewardAllMilk: pendingFalopa, totalStakedCount: totalStkCount, myStakedCount: selectedNFTS.length, totalMilkPower: tmpTotalMilkPower, myMilkPower: tmpMyMilkPower, dailyMilkRate: tmpDailyMilkRate});
